...
{
	JLabel areacode,mrcode,conno,conname,addr,mtrno,ir,cr,nodigit,tariff,phase,postno,cload,doc,dd1,mm1,yy1;
	JTextArea address;
	JTextField tid,con_no,con_name,post_no,c_load,mtr_no,i_r1,i_r2,c_r,no_digit,area_code4,mr_code4;
	JButton add1,add2,add3,add4,edit,save1,edit1,cancel,list, listall,update,mch;
	JComboBox ta_riff,cphase,d1,m1,y1,d2,m2,y2,d3,m3,y3,d4,m4,y4,d5,m5,y5,d6,m6,y6,d7,m7,y7,m55,y55,con_no1,con_no2,con_no3,con_no4,area_code,mr_code;
...
//************************************NEW CONSUMER********************************
		...
		ta_riff=new JComboBox(t);
		phase=new JLabel("phase");
		cphase=new JComboBox(p);	
...
//DEPOSIT DETAILS
	...
	dd.setForeground(new Color(180,0,230));
		...
		panel4.add(p28);
		  ...
		  public void actionPerformed(ActionEvent e)		
			...
			else if(e.getSource()==mr_code)
			{
				...
				pst.setString(4,(String)ta_riff.getSelectedItem());
				pst.setString(5,(String)cphase.getSelectedItem());
				...
				m=(String)m1.getSelectedItem();
				y=(String)y1.getSelectedItem();
				date=d+"/"+m+"/"+y;
				...
				try{
					...
					pst2.setString(7,rt_no1.getText());
					pst2.setString(9,rt_no2.getText());
					...
					dates1=ds1+"/"+ms1+"/"+ys1;
					pst2.setString(10,dates1);
					pst2.setString(11,inst_amt.getText());
					pst2.setString(12,paid_inst.getText());
					pst2.setString(13,bal_inst.getText());
