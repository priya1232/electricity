		...
		JPanel p6=new JPanel();
		      ...
		      public void focusLost(FocusEvent e)
		     {
				     ...
				     
				{
					...
					String period= (String)prd.getSelectedItem();
					if(period.equals("6"))
					{
						//long d = Long.parseLong((prd.getText()).trim());
		    ...
		    {}
			 ...
			 if(e.getSource()==ok)
				...
				try{
					...
					pst2.setInt(4,Integer.parseInt((String)prd.getSelectedItem()));
					//pst2.setString(4,"");
