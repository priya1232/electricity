...
public class SOPforteen6a extends JInternalFrame implements ActionListener
{
	...
	try{
		...
		JLabel l1 = new JLabel("SOP 14_VI A");
		l1.setFont(f);
...
/*	public static void main(String arg[])throws Exception
	{
		SOPforteen6a  sop146a= new SOPforteen6a();
		sop146a.setVisible(true);
	}*/
}