...
public class DemandWithdrawal extends JInternalFrame implements ActionListener
 { 
	JLabel conno,totaldemand,withdrawal,dmid,daycode;
	JComboBox con_no,area_code,day_code;
	JTextField total_demand,total_demand_u,withdrawals,withdrawalsu,dm_id;
	 JTextArea note;
	...
	public DemandWithdrawal(String title)
  	{
		...
		dmid.setForeground(new Color(170,30,120)); 
		...
		public void actionPerformed(ActionEvent e)
		{
	       ...
	       if(e.getSource()==con_no)
			...
			try{
				...
				dm_id.setText((String)em.nextElement());
				total_demand_u.setText((String)em.nextElement());
