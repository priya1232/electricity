...
public class SOPforteen6b extends JInternalFrame implements ActionListener
{
	...
	public SOPforteen6b()
	{
		...
		JLabel l1 = new JLabel("SOP 14_VI B");
		l1.setFont(f);
...
/*	public static void main(String arg[])throws Exception
	{
		SOPforteen6b  sop146b= new SOPforteen6b();
		sop146b.setVisible(true);
	}*/
}