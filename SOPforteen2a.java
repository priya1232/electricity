...
public class SOPforteen2a extends JInternalFrame implements ActionListener
{
	...
	public SOPforteen2a()
	{
		...
		JLabel l1 = new JLabel("SOP 14_II");
		l1.setFont(f);
...
/*	public static void main(String arg[])throws Exception
	{
		SOPforteen2a sop14a= new SOPforteen2a();
