...
public class SOPforteen extends JInternalFrame implements ActionListener
{
	...
	public SOPforteen()
	{
		...
		JLabel l1 = new JLabel("SOP 14  IA");
		l1.setFont(f);
...
/*	public static void main(String arg[])throws Exception
	{
		SOPforteen sop14= new SOPforteen();
		sop14.setVisible(true);
	}*/
}